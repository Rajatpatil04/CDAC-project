...
export default function HostNavbar() {
  ...
  return (
    <div>
      <Navbar className='hnavcol container-fluid' expand='md' style={{ display: mystate.loggedIn ? "block" : "none" }}>
        <div className="container-fluid">
          <Link to="/host/hosthome" className="navbar-brand">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="ml-auto" style={{ marginLeft: "auto" }}>
              ...
              <NavLink to="/host/hostbookings" className="nav-link text-dark"><h5 style={{ fontFamily: "serif" }}><b>BOOKINGS<br/> HISTORY</b></h5></NavLink>
