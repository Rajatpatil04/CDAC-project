...
public partial class BookmycarDbContext : DbContext
{
    public BookmycarDbContext()
    {
    }

    public BookmycarDbContext(DbContextOptions<BookmycarDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasOne(d => d.Req).WithMany(p => p.Bookings)
        ...
        modelBuilder.Entity<BookingRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.Car).WithMany(p => p.BookingRequests)
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.BookingRequests)
        ...
        modelBuilder.Entity<Car>(entity =>
        {
            ...
            entity.HasIndex(e => e.RcNo, "rc_no").IsUnique();
            ...
            entity.HasOne(d => d.Host).WithMany(p => p.Cars)
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.CatName, "cat_name").IsUnique();
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.PancardNo, "pancard_no").IsUnique();
        ...
        modelBuilder.Entity<FuelType>(entity =>
        {
            ...
            entity.HasIndex(e => e.FuelType1, "fuel_type").IsUnique();
        ...
        modelBuilder.Entity<Host>(entity =>
        {
            ...
            entity.HasIndex(e => e.AdharcardNumber, "adharcard_number").IsUnique();
            ...
            entity.HasIndex(e => e.PancardNumber, "pancard_number").IsUnique();
            ...
            entity.HasOne(d => d.Area).WithMany(p => p.Hosts)
                .HasForeignKey(d => d.AreaId)
                .HasConstraintName("hosts_ibfk_1");

            entity.HasOne(d => d.UidNavigation).WithMany(p => p.Hosts)
                .HasForeignKey(d => d.Uid)
        ...
        modelBuilder.Entity<Model>(entity =>
        {
            ...
            entity.HasOne(d => d.Cat).WithMany(p => p.Models)
        ...
        modelBuilder.Entity<Package>(entity =>
        {
            ...
            entity.HasIndex(e => e.Hours, "hours").IsUnique();
