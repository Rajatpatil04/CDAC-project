...
public class MyUserDetails implements UserDetails {
	...
	//  private boolean active;
	  ...
	  public static MyUserDetails build(com.example.demo.entities.User user) {
			...
			//{
				authority.add(new SimpleGrantedAuthority(r.getRole()));
			//}
			
			
			System.out.println(authority);
		   System.out.println(user);
			return new MyUserDetails( user.getUid(),user.getUsername(), user.getPassword(),user.getRole(),user.getStatus(), authority);
		  }
